...
GITHUB_RELEASES_API = "https://api.github.com/repos/Xerolux/idm-metrics-collector/releases/latest"
...
def check_for_update() -> Dict[str, Any]:
    ...
    update_type = get_update_type(current_version, latest_version) if update_available else "none"
