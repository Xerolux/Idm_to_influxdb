...
class Variable:
    ...
    def __init__(self, var_id: str, name: str, var_type: str,
                 query: Optional[str] = None, values: Optional[List[str]] = None,
                 default: Optional[str] = None, multi: bool = False,
...
class VariableManager:
    ...
    def add_variable(self, var_id: str, name: str, var_type: str,
                     query: str = None, values: List[str] = None,
                     default: str = None, multi: bool = False,
                     regex: str = None) -> Variable:
        """Add a new variable"""
        variable = Variable(
            var_id=var_id,
            name=name,
