  ...
  <div class="p-4 flex flex-col gap-4">
    ...
    <div v-else class="bg-gray-800 rounded p-4 font-mono text-sm h-[600px] overflow-y-auto">
      ...
      >
        ...
        <span :class="getLevelColor(log.levelname)" class="mx-2 font-bold">{{
          log.levelname
        }}</span>
    ...
    <Dialog
      ...
      modal
      header="Protokoll geteilt"
      :style="{ width: '500px' }"
    >
      <div class="flex flex-col gap-4">
        <p class="text-gray-300">
          Das Protokoll wurde erfolgreich hochgeladen und verschlüsselt. Dieser Link ist 1 Woche
          gültig.
        </p>
  ...
  try {
    ...
    if (res.data.success) {
      ...
      toast.add({
        severity: 'error',
        summary: 'Fehler',
        detail: res.data.error || 'Upload fehlgeschlagen',
        life: 5000
      })
    }
  } catch (e) {
