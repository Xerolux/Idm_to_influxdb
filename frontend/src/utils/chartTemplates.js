        ...
        charts: [
            ...
            },
            {
                ...
                queries: [
                    ...
                    { label: 'Quelle Eingang', query: 'idm_heatpump_temp_heat_source_input', color: '#06b6d4' },
                    { label: 'Quelle Ausgang', query: 'idm_heatpump_temp_heat_source_output', color: '#14b8a6' }
                ],
                hours: 24,
                yAxisMode: 'single'
            },
            {
                ...
                queries: [
                    { label: 'Vorlauf Ist', query: 'idm_heatpump_temp_flow_current_circuit_a', color: '#ef4444' },
                    { label: 'Vorlauf Soll', query: 'idm_heatpump_temp_flow_target_circuit_a', color: '#22c55e' },
    ...
    },
    {
        ...
        charts: [
            ...
            },
            {
                title: 'COP Verlauf',
                queries: [
                    { label: 'COP', query: 'idm_heatpump_power_current / idm_heatpump_power_current_draw', color: '#22c55e' }
                ],
                hours: 24,
                yAxisMode: 'single'
            }
