<template>
  ...
  >
    ...
    >
      ...
      <div class="flex items-center justify-between mt-2 flex-shrink-0">
        <div class="text-xs text-gray-500">
          Zeige {{ startIndex + 1 }}-{{ Math.min(endIndex, filteredRows.length) }} von
    ...
    <TableConfigDialog ref="configDialog" :table="tableConfig" @save="onConfigSave" />
