  ...
  >
    <div class="space-y-4">
      <div>
        ...
        <InputText v-model="localTimeline.title" class="w-full" placeholder="Timeline-Titel" />
      </div>
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          >
            ...
            />
            <ColorPicker v-model="localTimeline.stateColors[color]" format="hex" class="w-10" />
            <Button
        ...
        <p class="text-xs text-gray-500 mt-1">Definieren Sie hier die Zustände und ihre Farben</p>
      </div>
    </div>
