<template>
  ...
  >
    <div class="space-y-4">
      <div>
        ...
        <InputText v-model="localChart.title" class="w-full" placeholder="Chart-Titel" />
      </div>
          ...
          >
            <div class="flex-grow space-y-2">
              <div class="flex gap-2">
                <InputText v-model="query.label" placeholder="Label" class="flex-grow text-sm" />
                <Select
                  v-model="query.type"
                  :options="queryTypes"
                  optionLabel="label"
            ...
            <div class="flex items-center gap-1">
              <ColorPicker v-model="query.color" format="hex" class="w-10" />
              <Button
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <div class="flex items-center gap-1">
              <ColorPicker v-model="threshold.color" format="hex" class="w-10" />
              <Button
          ...
          <div
            v-if="localChart.alertThresholds.length === 0"
  ...
  <ExpressionBuilder
    ...
    :currentExpression="
      currentExpressionIndex !== null ? localChart.queries[currentExpressionIndex]?.expression : ''
    "
