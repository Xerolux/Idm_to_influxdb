  ...
  >
    <div class="space-y-4">
      <div>
        ...
        <InputText v-model="localTable.title" class="w-full" placeholder="Tabellen-Titel" />
      </div>
        ...
        <div class="space-y-2">
          ...
          >
            <div class="flex-grow space-y-2">
              <InputText v-model="column.label" placeholder="Label" class="w-full text-sm" />
              <InputText
                v-model="column.key"
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          >
            <div class="flex-grow space-y-2">
              <InputText v-model="query.label" placeholder="Label" class="w-full text-sm" />
              <InputText v-model="query.query" placeholder="Metric name" class="w-full text-sm" />
            </div>
            <Button
...
const open = () => {
  ...
  if (!localTable.value.columns) {
    localTable.value.columns = [{ key: 'timestamp', label: 'Zeit', type: 'timestamp' }]
  }
