...
<template>
  <div
    class="h-full flex flex-col justify-between group hover:bg-gray-700/30 transition-all duration-300 rounded-lg p-3 -m-2 border border-transparent hover:border-gray-600"
  >
    ...
    <div class="flex items-baseline gap-1 mt-auto">
      <div
        :class="['text-2xl sm:text-3xl font-bold truncate tracking-tight', statusColor]"
        :title="value"
      >
        {{ value }}
      </div>
