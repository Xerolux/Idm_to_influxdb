<template>
  <div class="bg-gray-800 rounded-xl p-4 border border-gray-700 h-full flex flex-col">
    ...
    <div class="space-y-3">
      <div
        class="flex items-center justify-between bg-orange-50/10 border border-orange-200/30 rounded-lg px-3 py-2"
      >
        <span class="text-sm font-medium">Building Power</span>
        <span class="text-xl font-bold"
          >{{ buildingPower }} <span class="text-sm font-normal">kW</span></span
        >
      </div>

      <div
        class="flex items-center justify-between bg-gray-700/50 border border-gray-600 rounded-lg px-3 py-2"
      >
        <span class="text-sm font-medium">HeatPump Power</span>
        <span class="text-xl font-bold"
          >{{ heatPumpPower }} <span class="text-sm font-normal">kW</span></span
        >
      </div>

      <div
        class="flex items-center justify-between bg-green-50/10 border border-green-200/30 rounded-lg px-3 py-2"
      >
        <span class="text-sm font-medium">3rd Floor ACs Power</span>
        <span class="text-xl font-bold"
          >{{ ac3Power }} <span class="text-sm font-normal">kW</span></span
        >
      </div>

      <div
        class="flex items-center justify-between bg-blue-50/10 border border-blue-200/30 rounded-lg px-3 py-2"
      >
        <span class="text-sm font-medium">1st Floor ACs Power</span>
        <span class="text-xl font-bold"
          >{{ ac1Power }} <span class="text-sm font-normal">W</span></span
        >
      </div>
    </div>
  </div>
